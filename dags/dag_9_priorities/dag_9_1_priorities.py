...
def dag_9_1_priorities():
    ...
    for partner, details in partners.items():
        @task.python(task_id=f"extract_{partner}", priority_weight=details['priority'], do_xcom_push=False, pool=details['pool'], multiple_outputs=True)
